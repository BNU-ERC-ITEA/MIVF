...
'''
# --------------------------------------------
# # training code for VideoFrame restoration(crop)
# --------------------------------------------
'''


def main(json_path='options/MIVF/MIVF_v1.json'):
    ...
    # tensorboard logger
    # ----------------------------------------
    a = f"{opt['path']['root']}/{opt['task']}/tensorboard_info"
    writer = SummaryWriter(f"{opt['path']['root']}/{opt['task']}/tensorboard_info")
    ...
    for epoch in range(1000000):  # keep running
        ...
        for i, train_data in enumerate(train_loader):
            ...
            logs_tb = model.current_log()
            for k, v in logs_tb.items():  # merge log information into message
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                if gt is not None:
                    ...
                    writer.add_scalar('psnr', ave_psnr, current_step)
                    writer.add_scalar('ssim', ave_ssim, current_step)
        ...
        writer.add_scalar('epoch_loss', ave_epoch_loss, epoch)
