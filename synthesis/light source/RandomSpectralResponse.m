...
passband_red = 50e-9 + rand * 20e-9;
passband_blue = 50e-9 + rand * 20e-9;
passband_green = 50e-9 + rand * 20e-9;
r_response = EvaluateGaussian(wavelengths, rgb_centers(1), passband_red);
g_response = 0.8 * EvaluateGaussian(wavelengths, rgb_centers(2), passband_green);
b_response = EvaluateGaussian(wavelengths, rgb_centers(3), passband_blue);
